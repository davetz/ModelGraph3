...
{
    public class Model_69E_ValueHead : List2ModelOf<QueryX, QueryX>
    {
        ...
        internal override IdKey IdKey => IdKey.Model_69E_ValueHead;
        internal Model_69E_ValueHead(Model_658_Compute owner, QueryX item, Relation_QueryX_QueryX qx_qx, Relation_Relation_QueryX re_qx) : base(owner, item) 
        {
