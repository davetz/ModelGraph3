...
namespace ModelGraph.Core
{
    public class Model_6A2_ChildRow : List1ModelOf<RowX>
    {
        ...
        public override bool ReorderItems(Root root, ItemModel dropModel) => (Owner is Model_6A7_ChildRelation o) && ReorderChildItems(root, o.GetRelation(), o.Item, Item, dropModel.GetItem());
