...
{
    public class Model_6A3_ParentRow : List1ModelOf<RowX>
    {
        internal Model_6A3_ParentRow(Model_6A8_ParentRelation owner, RowX item) : base(owner, item) { }
        internal override IdKey IdKey => IdKey.Model_6A3_ParentRow;
        ...
        public override bool ReorderItems(Root root, LineModel dropModel) => (Owner is Model_6A8_ParentRelation o) && ReorderChildItems(root, o.GetRelation(), o.Item, Item, dropModel.GetItem());
