...
{
    public class Model_6F2_HorzAlign : ItemModelOf<GraphModel>
    {
        internal Model_6F2_HorzAlign(ItemModel owner, GraphModel item) : base(owner, item) { }
        ...
        public override void GetButtonCommands(Root root, List<ItemCommand> list)
        {
            ...
            list.Add(new DrawCommand(this, IdKey.AlignCenterCommand, Item.Selector.AlignVertCenter));
