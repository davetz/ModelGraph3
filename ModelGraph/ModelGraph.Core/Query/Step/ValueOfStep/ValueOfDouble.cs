...
namespace ModelGraph.Core
{
    internal abstract class ValueOfDouble : ValueOfStep<double>
    {
        ...
        internal override long AsInt64() => throw new NotImplementedException(); // failed type check
        ...
        internal override long[] AsInt64Array() => throw new NotImplementedException(); // failed type check
