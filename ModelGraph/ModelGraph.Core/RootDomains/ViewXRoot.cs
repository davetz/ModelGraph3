...
{
    public class ViewXRoot : ExternalRoot<Root, ViewX>, ISerializer, IRootDomain
    {
        ...
        {
            root.RegisterInternalProperties(typeof(ViewX), GetProps(root)); //used by property name lookup
        }
