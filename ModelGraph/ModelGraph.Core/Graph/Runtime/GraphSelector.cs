...
{
    internal class GraphSelector : Selector
    {
        ...
        #region Constructor  ==================================================
        internal GraphSelector(Graph graph)
        {
            Graph = graph;
        }
        #endregion
        ...
        #region HitTestPoint  =================================================
        internal override void HitTestPoint(Vector2 p)
        {
            PrevNode = HitNode;
            PrevEdge = HitEdge;
        ...
        internal override void HitTestRegion(bool toggleMode, Vector2 p1, Vector2 p2)
        {
        ...
        internal override void SaveHitReference()
        {
            RefNode = HitNode;
            RefEdge = HitEdge;
            RefPoint = HitPoint;
        ...
        #region Align  ========================================================
        internal override void AlignVertLeft() { }
        internal override void AlignVertRight() { }
        internal override void AlignVertCenter()
        {
        ...
        internal override void AlignHorzTop() { }
        internal override void AlignHorzCenter()
        {
            if (RefNode is null || Nodes.Count < 2) return; // this is nonsense
        ...
        internal override void AlignHorzBottom() { }
        #endregion

        #region Flip  =========================================================
        internal override void FlipHorz()
        {
            if (RefNode is null || Nodes.Count < 2) return; // this is nonsense
        ...
        internal override void FlipVert()
        {
            if (RefNode is null || Nodes.Count < 2) return; // this is nonsense
