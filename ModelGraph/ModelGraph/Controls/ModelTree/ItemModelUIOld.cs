...
namespace ModelGraph.Controls
{
    internal class ItemModelUIOld
    {
        ...
        #region Constructor  ==================================================
        private ItemModelUIOld(ModelTreeControl tc, Canvas treeCanvas, TreeModel treeRoot, Root dataRoot)
        {
            TC = tc;
            DataRoot = dataRoot;
            TreeRoot = treeRoot;
        ...
        #region Allocate  =====================================================
        internal static void Allocate(ModelTreeControl tc, Canvas treeCanvas, TreeModel treeRoot, Root dataRoot, int count, Stack<ItemModelUIOld> stack)
        {
            for (int i = 0; i < count; i++)
            {
                stack.Push(new ItemModelUIOld(tc, treeCanvas, treeRoot, dataRoot));
            }
        }
        #endregion
